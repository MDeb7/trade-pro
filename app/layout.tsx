  ...
  <div className="bg-black text-white py-8">
    <div className="container mx-auto px-4">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <p className="text-sm mb-2">Windsor Corporate Centre 12th Floor, Block B</p>
          <p className="text-sm mb-2">MG Road, Bengaluru</p>
          <p className="text-sm mb-2">Karnataka - 560001</p>
      ...
      <div className="mt-8 pt-8 border-gray-200 flex flex-col md:flex-row justify-between items-center">
        <p className="text-sm text-gray-500 mb-4 mdLmb-0">
          {" "}
          © 2016-2024 TradePro. All rights reserved, Built in India
        </p>
      </div>
    </div>
  </div>
